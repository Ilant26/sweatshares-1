...
import { Shield, Users, UserPlus, Handshake } from 'lucide-react'
            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="relative">
                    <div className="text-center">
                        <h2 className="text-balance text-4xl font-semibold lg:text-5xl">Discover the power of SweatShares</h2>
                                           </div>
                    <div className="relative z-10 grid grid-cols-6 gap-3 mt-16">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">Free</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">Digital Vault</h2>
                                    <p className="text-foreground">Safely store your digital assets in a secure and private space.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-0 lg:px-6">
                                    <img 
                                        src="/landingimages/agreement.svg" 
                                        alt="Agreement" 
                                        className="w-full h-auto"
                                    />
                                </div>
                                <div className="relative z-10 mt-2 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">Make agreements</h2>
                                    <p className="text-foreground">Seamlessly share and manage agreements with ease through your vault.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Handshake
                                            className="m-auto size-5 text-blue-500"
                                            strokeWidth={1}
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Collaborate</h2>
                                        <p className="text-foreground">Work together seamlessly with your team. Share documents, collaborate on tasks, and stay connected in real-time.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                                    <img 
                                        src="/landingimages/share.svg" 
                                        alt="Share" 
                                        className="w-full h-auto"
                                    />
                                </div>
                        ...
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <UserPlus
                                            className="m-auto size-6 text-blue-500"
                                            strokeWidth={1}
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">Connect with people you need</h2>
                                        <p className="text-foreground">Find and connect with the right people for your needs. Share your projects with them and collaborate together.</p>
                                    </div>
                                </div>
