-- Safe User Deletion Script - DROP AND RECREATE VERSION
-- This script first drops existing functions, then recreates them correctly

-- Drop existing functions first
DROP FUNCTION IF EXISTS check_user_deletion_impact(uuid);
DROP FUNCTION IF EXISTS delete_user_safely(uuid);

-- Create the corrected delete function
...
-- Create the corrected impact check function
CREATE FUNCTION check_user_deletion_impact(user_id_to_check UUID)
