...
-- STEP 2: Add the constraint (if not already added)
...
-- STEP 3: Make title and description required
ALTER TABLE public.notifications 
...
-- STEP 7: Create NEW function to get unread count
...
-- STEP 8: Create NEW function to mark notifications as read
